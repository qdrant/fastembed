...
class OnnxCrossEncoderModel(OnnxModel):
    def __init__(self, model_name: str, cache_dir: str = None, threads: int = None, providers: Sequence[OnnxProvider] = None, **kwargs):
        super().__init__()
    ...
    def encode(self, query: str, documents: Sequence[str]) -> Sequence[float]:
