...
supported_pooled_models = [
    {
        ...
        "dim": 768,
        "description": "Text embeddings, Multimodal (text, image), English, 8192 input tokens truncation, Prefixes for queries/documents: necessary, 2024 year. License: apache-2.0",
        "size_in_GB": 0.52,
        "sources": {
